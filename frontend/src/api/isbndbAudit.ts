...
export type ISBNdbAuditItem = { book_id: number; isbn: string; status: string; checked_at: string; title?: string; error?: string | null; http_status?: number | null };
...
export const retryISBNdbAuditErrors = async () => (await client.post("/isbndb-audit/retry-errors")).data as ISBNdbAuditSummary;
