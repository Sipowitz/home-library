        ...
        with db.begin():
            ...
            if data.preferences is not None:
                ...
                db.add(models.UserPreferences(user_id=user_id, date_format=pref.date_format, time_format=pref.time_format,
                    ...
                    appearance_mode=pref.appearance_mode, show_collections_in_library=pref.show_collections_in_library,
                    root_collection_display_mode=pref.root_collection_display_mode,
